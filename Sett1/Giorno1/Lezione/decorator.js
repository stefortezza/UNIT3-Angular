...
function Logger(constructor) {
    ...
    console.log(constructor); // 7. Secondo log: riceve come parametro il constructor della classe, cioè la funzione di classe, lo stampa, DOPO esegue l'istanza di classe, perché il decoratore ha esaurito il suo compito
}
var Persone = function () {
    ...
    var Persone = _classThis = /** @class */ (function () {
        function Persone_1(_name) {
            this.name = _name;
            console.log('Creazione persona...'); // 8. Lístanza di classe esegue il metodo del costruttore della classe
        }
        return Persone_1;
    }());
...
var myPerson = new Persone('Mario Rossi'); // 2. Istanza di classe
